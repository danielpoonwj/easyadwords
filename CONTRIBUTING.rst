...
easyadwords could always use more documentation, whether as part of the
official easyadwords docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `easyadwords` repo on GitHub.
